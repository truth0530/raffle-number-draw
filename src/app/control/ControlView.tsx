  ...
  return (
    <main style={wrap}>
      <h1 style={{ fontSize: 22, fontWeight: 800 }}>
        관리자 리모컨
        {isTest && <span style={{ marginLeft: 8, fontSize: 14, fontWeight: 800, background: "#7f1d1d", padding: "3px 10px", borderRadius: 8, verticalAlign: "middle" }}>🧪 테스트</span>}
      </h1>
      {isTest && (
        <p style={{ marginTop: 8, fontSize: 13, opacity: 0.6 }}>
          이 컴퓨터 안에서만 동작하는 연습용입니다. 실제 행사 데이터에 전혀 영향을 주지 않습니다.
        </p>
      )}
